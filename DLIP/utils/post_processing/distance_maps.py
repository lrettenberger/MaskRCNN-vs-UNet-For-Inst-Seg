...
for phase in ['train','val','test']:
    masks = glob(f'/home/ws/kg2371/datasets/sem-segmentation-high-mag/{phase}/labels_confident/*.tif')
    Path(f'/home/ws/kg2371/datasets/sem-segmentation-high-mag/{phase}/dist_maps_labels_confident/').mkdir(parents=True, exist_ok=True)
    ...
    for mask_path in tqdm(masks):
        ...
        tifffile.imwrite(mask_path.replace('labels_confident','dist_maps_labels_confident'),(weights/255.0).astype(np.float32))