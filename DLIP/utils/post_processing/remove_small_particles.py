...
# masks = glob('/home/ws/kg2371/datasets/sem_segmentation_cleaned_round_3_full_size/train/labels/*.tif')
# particle_sizes = []
...
for phase in ['train','val','test']:
    ...
    masks = glob(f'/home/ws/kg2371/datasets/sem_segmentation_cleaned_round_3_full_size/{phase}/labels/*.tif')
    
    # creating dirs
    Path(f'/home/ws/kg2371/datasets/sem_segmentation_cleaned_round_3_full_size/{phase}/labels{REMOVED_PARTICLES_SUFFIX}/').mkdir(parents=True, exist_ok=True)
    Path(f'/home/ws/kg2371/datasets/sem_segmentation_cleaned_round_3_full_size/{phase}/dist_maps{REMOVED_PARTICLES_SUFFIX}/').mkdir(parents=True, exist_ok=True)
