...
for i in range(6):
    Path(f"/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_pred_plot").mkdir(parents=True, exist_ok=True)
    Path(f"/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_true_plot").mkdir(parents=True, exist_ok=True)
    for j in range(16):
        ma = visualize_instances_map(cv2.imread(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/x/{j}.png'),cv2.imread(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_true/{j}.png',-1),line_thickness=2)
        cv2.imwrite(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_true_plot/{j}.png',ma)
        ma = visualize_instances_map(cv2.imread(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/x/{j}.png'),cv2.imread(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_pred/{j}.png',-1),line_thickness=2)
        cv2.imwrite(f'/home/ws/kg2371/projects/sem-segmentation/plots/Mask/bin_{i}/y_pred_plot/{j}.png',ma)
